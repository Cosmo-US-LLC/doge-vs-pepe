...
export const bigIntToNum = (num, decimals) => {
	return new Decimal(num.toString()).div(new Decimal(10).pow(decimals)).toNumber()
}
...
export const bigIntToStr = (num, decimals) => {
	return new Decimal(num.toString()).div(new Decimal(10).pow(decimals)).toFixed()
}
