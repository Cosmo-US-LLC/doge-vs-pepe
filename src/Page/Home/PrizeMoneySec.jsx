...
function PrizeMoneySec() {
  return (
    <div
      className="w-[100%] h-[720px] flex justify-center items-center  relative "
      id="prize_money"
    >
      <div className="gradient-bg max-w-[1280px] h-[580px] p-[1px] overflow-hidden rounded-[43px] w-[100%]">
