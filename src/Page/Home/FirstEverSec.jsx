...
import imgl from "../../assets/FirstEver/59.png";
import imgr from "../../assets/FirstEver/img (1).webp";
    ...
    <div className="relative w-[100%] bgeversec overflow-hidden pt-[60px] pb-[80px]">
      ...
      <div className="max-w-[1291.63px] space-y-[45px] w-[100%] mx-auto relative min-h-[500px]">
       ...
       <div className="relative">
            <img src={imgl} className="w-[560px] h-[363px] absolute top-[16%] left-[-6%]" alt="" />
        <div className="max-w-[641px] mx-auto w-[100%]">
            <p className="text-[#fff] text-[18px] text-center leading-[114%] font-[400]">Welcome to <span className="font-[700] relative z-20">Team Doge</span> vs. <span className="font-[700] relative z-20">Team Pepe</span>, where you get to decide who <br /> wins! This isn’t just another crypto presale—it’s a fast, fun competition that <br /> lets the community decide. <br /> <br /> 
