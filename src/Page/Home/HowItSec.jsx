...
function HowItSec() {
  return (
    <div className="w-[100%] howitbg overflow-hidden pt-[60px] pb-[80px]">
      <div className="max-w-[992px] relative px-[22px] py-[40px] rounded-[26.9px] space-y-[23px] w-[100%] mx-auto relative min-h-[500px] howitborder bg-[#01010182]" 
      style={{backdropFilter:"blur(9.899999618530273px)"}}
      >
        <div className="space-y-[20px]">
            <p className="text-[#fff] leading-[114%] font-[400] text-[20px] text-center">Chapter I</p>
          ...
          <div className="flex justify-center space-x-[4rem]">
            <div className="flex justify-center items-center space-x-2">
                <p className="text-[18px] font-[600] text-[#fff] uppercase"> Join X</p>
                <img className="cursor-pointer" src={telicon1} alt="" />
            </div>
            <div className="flex justify-center items-center space-x-2">
                <p className="text-[18px] font-[600] text-[#fff] uppercase"> Join Telegram</p>
                <img className="cursor-pointer" src={telicon2} alt="" />
            </div>
          </div>
          </div>
        </div>
        <img src={vecleft} className="absolute bottom-[-10%] left-[-32%]" alt="" />
        <img src={vecright} className="absolute bottom-[-10%] right-[-35%]" alt="" />
      </div>
    </div>
  );
}
