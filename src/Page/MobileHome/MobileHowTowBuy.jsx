  ...
  return (
    ...
    >
      ...
      <div className="relative px-4 pb-24 mx-auto max-w-7xl">
        <div className="flex flex-col justify-center gap-4 w-[100%] mt-6 max-w-[100%] mx-auto">
          {steps.map((s, i) => (
            <article
              key={i}
              className="group relative rounded-[20px] bg-black text-white p-[1px] bg-gradient-to-r from-[#DD5B01] via-[#E67500] to-[#00FF2F] flex-1 max-w-[100%]"
            >
              <div className="absolute -inset-[1px] rounded-[20px] bg-gradient-to-b from-lime-400/0 via-lime-400/0 to-lime-400/0 opacity-0 group-hover:opacity-100 " />

              <div className="flex relative flex-col h-full bg-[#000] pb-[30px] px-[20px] pt-[20px] rounded-[20px]">
                <h3 className="mt-3 font-anton font-[400] text-[24px] tracking-tight leading-[28px] uppercase">
                  <span
                    style={{
                      background:
        ...
        <div className="w-[100%] mt-6 flex justify-center items-center">
          <button
            className="bg-gradient-to-r from-[#DD5B01] via-[#E67500] to-[#00FF2F] max-w-[100%] w-[100%] leading-normal !text-[22px] mx-auto h-[60px] text-anton font-[400] rounded-[60px] cursor-pointer relative z-10"
            onClick={() => {
