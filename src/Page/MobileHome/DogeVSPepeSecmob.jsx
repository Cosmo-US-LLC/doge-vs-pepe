          ...
          <div className="crypbg rounded-[15.016px] border min-h-[614.73px] max-w-[675.732px]  border-[#fff]">
            ...
            <div className="px-[35px] space-y-[20px] pt-[290px] pb-[20px] relative overflow-hidden">
              <div className="relative z-10 space-y-0">
                <h3 className="text-[42.703px] font-[400] text-[#fff] leading-normal  uppercase font-anton">
                  <span className="text-[#FFBF01]">Doge</span> vs{" "}
                  <span className="text-[#00FF2F]">Pepe ?</span>
                </h3>

                <p className="w-[500.806px] h-[131.076px] rotate-[-0.081deg] flex-shrink-0 text-[#FFF] font-helvetica text-[16px] font-[400] leading-[22px]">
              ...
              <div className="relative z-10 flex space-x-2">
                <h4 className=" text-[16px] font-[400] leading-[32px] font-helvetica text-[#fff]">
                  Find out more
                </h4>
          ...
          <div className="flex flex-col justify-between space-y-[20px]">
            <div className="crypbg2 rounded-[15.016px] border min-h-[300.97px]  max-w-[675.732px]  border-[#fff]">
              ...
              <div className="px-[15px] pt-[126px] space-y-[10px]  pb-[20px]">
                <div className="">
                  <h3 className="text-[20px] leading-normal font-[400] text-[#fff] uppercase font-anton">
                    <span className="text-[#FFBF01]">legendary</span>
                    <span className="text-[#00FF2F]">memes face off</span>
                  </h3>

                  <p className="w-[305.664px] h-[67.998px] rotate-[-0.081deg] flex-shrink-0 text-[#FFF] font-helvetica text-[14px] font-[400] leading-[17px] pt-[10px]">
                ...
                <div className="flex pt-2 space-x-2">
                  <h4 className="text-[16px] font-[400] leading-3 font-helvetica text-[#fff]">
                    Find out more
                  </h4>
                  <img src={arw} alt="" />
                </div>
            ...
            <div className="crypbg3 rounded-[15.016px] border min-h-[300.97px]  max-w-[675.732px]  border-[#fff]">
              ...
              <div className="px-[15px] pt-[112px] space-y-[10px]  pb-[20px]">
                <div className="">
                  <h3 className="text-[20.907px] leading-[100%] font-[400] text-[#fff] uppercase font-anton">
                    <span className="text-[#FFBF01]">Who will</span>
                    <span className="text-[#00FF2F]">be the Winner</span>
                  </h3>

                  <p className="w-[309.443px] h-[69.514px] rotate-[-0.081deg] flex-shrink-0 text-[#FFF] font-helvetica text-[14px] font-[400] leading-[18.592px] pt-[5px]">
...
export default DogeVSPepeSecMob;
