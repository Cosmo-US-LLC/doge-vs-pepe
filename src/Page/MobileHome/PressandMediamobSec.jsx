        ...
        <div className="max-w-[510px] w-[100%] relative">
          ...
          >
              <div className="Pressborder  flex justify-between flex-col min-h-[350px] max-w-[333px] h-[100%] px-2 pt-10 pb-5 w-[100%]">
                ...
                <div className="flex items-start h-[100%]">
                    <p className="text-[15px] text-[#fff] text-center font-[400]">Two legendary memes face off in an exciting presale, with rumors of well-known crypto developers behind the project. This could be the next big thing!</p>
                </div>
          ...
          >
              <div className="Pressborder  flex justify-between flex-col min-h-[350px] max-w-[333px] h-[100%] px-2 pt-10 pb-5  w-[100%]">
                ...
                <div className="flex items-start h-[100%]">
                    <p className="text-[15px] text-[#fff] text-center font-[400]">Finding the next winning narrative is the key to hitting big with memes. Two presales, but only one will win and launch! Backed by two of the most iconic meme coins, this might just be it.</p>
                </div>
