    ...
    <div className="w-[100%] relative" id="how-to-buy">
      <div className="max-w-[922px] ">
        <div className="flex flex-col justify-end relative pt-10 pb-[4rem] space-y-[20px] px-4 min-h-[990px] bgwltsecmobUp ">
          ...
          <div className=" max-w-[100%] px-4 bg-[#F2B60F] w-[100%] space-y-[10px]  px-[13px] pb-[15px] pt-[15px] rounded-[13px] border border-[#fff]">
            ...
            <div className=" pb-1 space-y-[10px]">
              ...
              <div className="flex justify-between">
                <h4 className="text-[14px] font-[Anton] font-[400] text-[#000]">
                  USD Raised
                </h4>
                <h5 className="text-[14px] font-[400] font-[Anton] text-[#000]">
                  {" "}
                  $1,000,000
                </h5>
              </div>
            ...
            <div className="border-[1px] p-1 rounded-[13px] space-y-[15px] border-[#fff]">
              <div>
                <h3 className="text-[16px] font-[400] font-[Anton] text-center leading-[150%] text-[#000]">
                  1 Team Pepe = $0.006
                </h3>
              </div>
              ...
              <div className=" space-y-[5px]">
                <h5 className="text-[#000] text-[16px] font-[Helvetica] font-[400] text-center">
                  Accepting
                </h5>
                <div className="flex justify-between space-x-1 max-w-[230px] mx-auto">
                  {iconsData.map((item) => (
                    <img
                      key={item.id}
                      src={item.img}
              ...
              <div className="space-y-[10px]">
                <div className="flex justify-center">
                  <button className="bg-[#000] text-[#FFF] font-[Anton] max-w-[100%] mx-auto w-[100%] h-[25px] text-[14px] font-[400] rounded-[8px]">
                    Connect Wallet
                  </button>
                </div>
        ...
        <div className="flex flex-col justify-end py-10 space-y-[20px] px-4 min-h-[1060px] bgwltsecmobDn ">
          <div>
            <h3
