      ...
      <div className="two_legends_bg relative">
        ...
        <div className="flex w-[100%] pt-[300px]  px-2 flex-col ">
          ...
          <div className=" w-[100%]  relative z-[99] flex flex-col gap-[20px] pl-2">
            <h3 className="text-[32px]">Two Legends. One Crown.</h3>
            <h4 className="w-full">
              {" "}
              <span className="h-[12px] w-[12px] rounded-full bg-[#C90F0F] inline-block mr-2 mb-1"></span>
              <span className=" !text-[24px] !leading-[135%] !tracking-[1.4px]">
            ...
            <div className="relative mx-auto w-[100%] h-[70px] z-[99] overflow-hidden">
              ...
              <h4 className="absolute top-[27px] left-[-60px] w-full h-full !text-[14px] !text-[#000] subtext text-center">
                The first to hit <span className="text-[#C90F0F]">$1M</span> wins
              </h4>
              <h4 className="absolute top-[27px] left-[63px] w-full h-full !text-[14px] !text-[#000] rotate-[8deg] subtext text-center">
                the presale
              </h4>
              <h4 className="absolute top-[27px] left-[140px] w-full h-full !text-[14px] !text-[#000] rotate-[-8deg] subtext text-center">
                round
              </h4>
            </div>
          </div>
