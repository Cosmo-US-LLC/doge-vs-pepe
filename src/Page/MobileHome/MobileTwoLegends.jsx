  ...
  return (
    <div className="flex relative flex-col pt-4 pb-14" id="what_is">
      <div className="relative two_legends_bg">
        ...
        />
        <div className="flex w-[100%] pt-[390px]  px-2 flex-col ">
            ...
            <div className="flex flex-col gap-4 justify-between">
              <div className="flex flex-col gap-2 border-2 border-[#DD5B01] p-[30px] rounded-[30px]">
                <div className="flex flex-row gap-2 items-center">
                  ...
                  <h4 className="">TEAM DOGE</h4>
                </div>
                <p className="subtext !text-[#FFFFFF99]">
                  <span className="text-[#E67500] font-bold uppercase">Doge </span>, the
              ...
              <div className="flex flex-col gap-2 border-2 border-[#00FF2F] p-[30px] rounded-[30px]">
                ...
                <p className="subtext !text-[#FFFFFF99]">
                  <span className="text-[#00FF2F] font-bold uppercase">Pepe </span>, the
                  fearless rising star, already in the top 3 meme heavyweights,
                  known for his brutal knockouts.
                </p>
              </div>
            </div>
            <div className="relative uppercase mx-auto w-[100%] h-[70px] z-[99] overflow-hidden">
              <img src={white_bg} alt="" className="w-full h-full" />
              <h4 className="absolute top-[27px] left-[-60px] w-full h-full !text-[14px] !text-[#000] !font-bold subtext text-center">
                The first to hit{" "}
                <span className="text-[#C90F0F] font-bold">$1M</span> wins
              </h4>
              <h4 className="absolute top-[27px] left-[63px] w-full h-full !text-[14px] !text-[#000] !font-bold rotate-[8deg] subtext text-center">
                the presale
              </h4>
              <h4 className="absolute top-[27px] left-[140px] w-full h-full !text-[14px] !text-[#000] !font-bold rotate-[-8deg] subtext text-center">
                round
              </h4>
            </div>
          </div>
