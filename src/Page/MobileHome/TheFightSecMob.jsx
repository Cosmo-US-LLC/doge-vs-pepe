...
import mobimg from "../../assets/mobile_assets/fight_mob.png";
...
function TheFightSecMob() {
  ...
  return (
    <div className="relative w-[100%] fight_mob_bg pt-[90px] pb-[60px] overflow-hidden">
      <div className=" w-[90%] mx-auto space-y-[20px] ">
        <div className="space-y-[12px]">
          ...
          <p className="text-[14px] max-w-[869px] font-[Helvetica] w-[100%] mx-auto text-center font-[400] text-[#fff] leading-[171.429%]">
