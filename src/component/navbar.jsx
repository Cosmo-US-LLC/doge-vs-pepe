  ...
  return (
    <div className="fixed w-[100%] z-[99] bg-[#000000]">
      <div className="max-w-[1296px] relative 2xl:w-[100%] xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[90%] w-[100%] mx-auto 2xl:h-[112px] xl:h-[112px] lg:h-[112px] md:h-[112px] sm:h-[62px] h-[62px] flex justify-between items-center px-[17px]">
        ...
        {menuOpen && (
          <div className="absolute top-[65px] left-[20px] w-[200px] bg-[#000000] text-[#FFFFFF] z-[100]">
            <div className="border-[2px] border-white rounded-[4px] px-2 py-4">
              <a
                href="#what-is"
                className="block py-[8px] px-[12px] text-[#FFF] font-k2d font-semibold text-[14px] leading-[15.657px] border-b border-[#fff]"
                onClick={(e) => handleScroll(e, "what-is", 90)}
              >
                What is DOGEVSPEPE
              </a>
