...
import TokenInputMob from "../../TokenInputMob";
...
const BuyTabMob = () => {
	...
	/** @type {State<import("../../TokenInputMob").InputRef>} */
	...
	return (
		<>
			...
			<button
				className={clsx(
					"bg-[#000] text-[#FFF] max-w-[166.331px] mx-auto mt-1 w-[100%] h-[25px] text-[12px] font-[700] rounded-[50px] transition-all duration-300 hover:bg-[#0184E2] hover:text-[#FFFFFF] hover:opacity-90 cursor-pointer",
			...
			<div className="flex items-center justify-center ">
				<p className="text-[9px] font-normal text-black font-k2d capitalize leading-normal">
					Max Buy-in $25,000
				</p>
			</div>
			{createdTransaction && (
...
const CodeInputs = () => {
	...
	return (
		<div ref={setCodeInputRef} className="flex flex-col gap-1">
			<CodeInput
				label="Bonus Code"
	...
	return (
		<div className="flex items-center flex-1 h-10 gap-1">
			<div className="relative cursor-pointer group">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"><path fill="#000" d="m13.683 10.08.63.407zM9.25 9a.75.75 0 0 0 1.5 0zm2 4.5a.75.75 0 0 0 1.5 0zm1.5 2.5a.75.75 0 0 0-1.5 0zm-1.5 1a.75.75 0 0 0 1.5 0zm10-5A9.25 9.25 0 0 1 12 21.25v1.5c5.937 0 10.75-4.813 10.75-10.75zM12 21.25A9.25 9.25 0 0 1 2.75 12h-1.5c0 5.937 4.813 10.75 10.75 10.75zM2.75 12A9.25 9.25 0 0 1 12 2.75v-1.5C6.063 1.25 1.25 6.063 1.25 12zM12 2.75A9.25 9.25 0 0 1 21.25 12h1.5c0-5.937-4.813-10.75-10.75-10.75zM13.25 9c0 .25-.073.48-.198.675l1.262.812A2.74 2.74 0 0 0 14.75 9zm-2.5 0c0-.69.56-1.25 1.25-1.25v-1.5A2.75 2.75 0 0 0 9.25 9zM12 7.75c.69 0 1.25.56 1.25 1.25h1.5A2.75 2.75 0 0 0 12 6.25zM11.25 13v.5h1.5V13zm1.802-3.325a8 8 0 0 1-.468.628c-.178.22-.386.473-.573.73-.369.507-.761 1.168-.761 1.967h1.5c0-.305.15-.64.474-1.084.159-.219.334-.43.528-.672.187-.232.389-.489.562-.757zM11.25 16v1h1.5v-1z"/></svg>
				<div className="transition-opacity pointer-events-none group-hover:pointer-events-auto opacity-0 group-hover:opacity-100 bg-[#191f1f] p-2 absolute top-full -left-4 md:left-0 text-[#fff] w-40 md:w-56 text-xs leading-4 rounded-lg">
			...
			<div className="flex-1 gap-2 font-bold flex items-center self-stretch bg-[#00000078] rounded-lg text-[9px]">
				{applied ? (
				...
				<button
					className={clsx(
						"text-[9px] h-[20px] min-w-[1.75rem] items-center justify-center flex-shrink-0 px-1.5 my-0.5 mr-0.5 bg-[#000] text-[#fff] flex self-center rounded-lg hover:bg-[#111] transition-colors",
